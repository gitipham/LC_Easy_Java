...
public class ReverseInteger {
    ...
    public static void main(String[] args) {
        System.out.println(reverse(15426489)); //calling method to reverse the integer
    }
    ...
    public static int reverse(int x) {
        ...
        if (x > 0)
            ...
            return Integer.parseInt(newNum.toString()) * (-1); // add the (-) sign if the original number was a negative number
    } // end of method
}
